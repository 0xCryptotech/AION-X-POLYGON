...
```
User stakes: 100 MATIC
Platform fee: 5% = 5 MATIC
Net stake: 95 MATIC

Winner receives: 190 MATIC (2x net stake)
Platform keeps: 10 MATIC (5% from both players)
```

**Revenue Calculation:**
```
Per Battle:
- Player 1 stake: 100 MATIC
- Player 2 stake: 100 MATIC (or house)
- Total pot: 200 MATIC
- Platform fee (5%): 10 MATIC
- Winner gets: 190 MATIC

If MATIC = $1:
- Platform earns: $10 per battle
- AI cost: $0.018 per battle
- Net profit: $9.98 per battle
```
...
```
Weekly Tournament:
- Entry fee: 50 MATIC ($50)
- 200 participants
- Total pot: 10,000 MATIC ($10,000)
- Prize distribution: 80%
- Platform keeps: 20% = 2,000 MATIC ($2,000)

Monthly Tournament:
- Entry fee: 200 MATIC ($200)
- 500 participants
- Total pot: 100,000 MATIC ($100,000)
- Prize distribution: 80%
- Platform keeps: 20% = 20,000 MATIC ($20,000)
```

**Monthly Revenue:**
```
4 Weekly tournaments: $8,000
