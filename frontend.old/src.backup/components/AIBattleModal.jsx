...
function FullscreenBattleModal({ onClose }) {
  ...
  const [openMarkets, setOpenMarkets] = useState([
    {id: 201, title: 'BTC/USD 10min', mode: 0, closeTime: Math.floor(Date.now()/1000) + 3600, status: 0, totalStaked: '0'},
    {id: 202, title: 'ETH/USD 10min', mode: 0, closeTime: Math.floor(Date.now()/1000) + 3600, status: 0, totalStaked: '0'}
  ]);
