...
export const MarketModal = ({ market, open, onClose }) => {
  ...
  const handlePlaceBet = () => {
    ...
    // Mock bet placement
    toast.success(`Bet placed! ${betAmount} BNB on "${market.outcomes[selectedOutcome].name}"`);
    setBetAmount('');
        ...
        <div className="space-y-6 mt-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="glass p-4 rounded-lg">
              ...
              <div className="font-mono text-2xl font-bold text-accent">{formatBNB(totalPool)} BNB</div>
            </div>
            <div className="glass p-4 rounded-lg">
              <div className="flex items-center space-x-2 text-muted-foreground mb-2">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="mt-2 text-sm text-muted-foreground">
                        Pool: <span className="font-mono text-accent">{formatBNB(outcome.pool)} BNB</span>
                      </div>
                    </button>
                  );
                })}
                ...
                <div className="glass p-4 rounded-lg">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-mono text-xl font-bold text-accent">
                      ~{formatBNB((parseFloat(betAmount) * totalPool) / market.outcomes[selectedOutcome].pool)} BNB
                    </span>
                  </div>
                </div>
              )}
