  ...
  const stats = [
    {
      ...
      value: `${formatBNB(mockPortfolio.totalInvested)} BNB`,
      icon: TrendingDown,
      color: 'text-primary',
    },
    {
      label: 'Total Earnings',
      value: `${formatBNB(mockPortfolio.totalEarnings)} BNB`,
      icon: TrendingUp,
      color: 'text-accent',
    },
    {
      label: 'Profit/Loss',
      value: `${mockPortfolio.profitLoss >= 0 ? '+' : ''}${formatBNB(mockPortfolio.profitLoss)} BNB`,
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between space-y-4 lg:space-y-0">
                    ...
                    <div className="flex items-center space-x-8">
                      <div>
                        ...
                        <div className="font-mono text-lg font-semibold">{formatBNB(bet.amount)} BNB</div>
                      </div>
                      <div>
                        ...
                        <div className="font-mono text-lg font-semibold text-accent">
                          {formatBNB(bet.potentialReturn)} BNB
                        </div>
                      </div>
                      <Button
                        variant="outline"
