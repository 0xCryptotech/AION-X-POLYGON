...
export const HistoryPage = () => {
  ...
  const statCards = [
    ...
    {
      label: 'Total Won',
      value: `${stats.totalWon.toFixed(4)} BNB`,
      icon: TrendingUp,
    ...
    {
      label: 'Profit/Loss',
      value: `${stats.profitLoss >= 0 ? '+' : ''}${stats.profitLoss.toFixed(4)} BNB`,
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          <div className={`text-lg font-bold ${
                            ...
                            {battle.result === 'win' ? `+${battle.payout?.toFixed(4)}` : battle.result === 'loss' ? `-${battle.stake?.toFixed(4)}` : '0.0000'} BNB
                          </div>
                          <div className="text-xs text-slate-400">
                            Stake: {battle.stake?.toFixed(4)} BNB
                          </div>
                        </div>
                      </div>
                    </div>
