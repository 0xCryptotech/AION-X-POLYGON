  ...
  const steps = [
    {
      ...
      description: 'Connect your MetaMask or any Web3 wallet to get started with BNB.',
    },
    {
      icon: TrendingUp,
  ...
  const features = [
    {
      ...
      description: 'All bets are recorded on the BNB Smart Chain with full transparency.',
    },
    {
      icon: Zap,
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-muted-foreground">
                  AION-X runs on the BNB Smart Chain Testnet (Chain ID: 97) for fast, low-cost transactions.
                </p>
              </div>
