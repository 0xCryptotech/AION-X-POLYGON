...
export const TournamentPage = () => {
  ...
  const sponsorCup = [
    ...
    },
    {
      ...
      type: 'Sponsored',
      sponsor: 'MetaMask',
      description: 'Win BNB + exclusive MetaMask NFT collection'
    },
    {
      id: 3,
  ...
  const leaderboard = [
    { rank: 1, name: 'CryptoKing', score: 9850, prize: '15 BNB' },
    { rank: 2, name: 'AImaster', score: 9420, prize: '10 BNB' },
    { rank: 3, name: 'TradeBot', score: 8990, prize: '7 BNB' },
    { rank: 4, name: 'ProTrader', score: 8560, prize: '5 BNB' },
    { rank: 5, name: 'BullRunner', score: 8230, prize: '3 BNB' }
  ];
