        ...
        {markets.map(m => (
          <div key={m.id} className="mb-4 p-4 border rounded">
            ...
            <div className="mt-2">
              ...
              <div>
                <button onClick={()=>placeBetOnChain(m.id,0,"0.001")} className="mr-2">Bet Outcome 0 (0.001 MATIC)</button>
                <button onClick={()=>placeBetOnChain(m.id,1,"0.001")}>Bet Outcome 1 (0.001 MATIC)</button>
              </div>
            </div>
